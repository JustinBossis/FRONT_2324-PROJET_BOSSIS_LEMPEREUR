...
export class EventService {
  ...
  addFavoriteEvent(idEvent: string): Observable<any | undefined>{
    ...
    return this.http.post<any>('http://localhost:3000/user/addFavoriteEvent', {idEvent: idEvent}, { headers: headers});
  }
  ...
  removeFavoriteEvent(idEvent: string): Observable<any | undefined>{
    ...
    return this.http.post<any>('http://localhost:3000/user/removeFavoriteEvent', {idEvent: idEvent}, { headers: headers});
  }
